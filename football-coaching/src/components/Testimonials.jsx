    ...
    <section id="testimonials">
        ...
        <div className="cards">
            <div className="testimonial-card">
                <p>"This personalised coaching program completely transformed my game. Within a couple of months I saw massive improvements in my tactical awareness and decision making on the pitch. I can't recommend Ro-Motion more."</p>
                <h3>Chloe Kelly</h3>
                <p className="player-team">Arsenal and England Women's National Team</p>
            </div>
            <div className="testimonial-card">
                ...
                <h3>Vivianne Miedema</h3>
                <p className="player-team">Manchester City and The Netherland's Women's National Team</p>
            </div>
            <div className="testimonial-card">
                ...
                <h3>Fuka Nagano</h3>
                <p className="player-team">Liverpool and Japanese Women's National Team</p>
            </div>
        </div>
    </section>
    )
